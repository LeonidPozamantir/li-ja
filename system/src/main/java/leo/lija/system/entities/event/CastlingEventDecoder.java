...
public class CastlingEventDecoder implements EventDecoder {
    ...
    public Optional<Event> decode(String str) {
        ...
        char r2 = chars[3];
        char c = chars[4];
        return Optional.ofNullable(Piotr.decodePos.get(k1))
            .flatMap(king1 -> Optional.ofNullable(Piotr.decodePos.get(k2))
                .flatMap(king2 -> Optional.ofNullable(Piotr.decodePos.get(r1))
                    .flatMap(rook1 -> Optional.ofNullable(Piotr.decodePos.get(r2))
