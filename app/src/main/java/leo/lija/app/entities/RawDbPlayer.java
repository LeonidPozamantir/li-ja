...
public class RawDbPlayer {
    ...
    public RawDbPlayer copy() {
        return new RawDbPlayer(id, color, ps, aiLevel, isWinner, elo, isOfferingDraw, lastDrawOffer, isOfferingTakeback, userId, eloDiff, mts, blurs);
    }
    ...
    public static RawDbPlayer encode(DbPlayer dbPlayer) {
        return new RawDbPlayer(
            ...
            dbPlayer.getIsOfferingTakeback(),
