...
class PgnDumpTest {
    ...
    class onlyMoves {
        ...
        void peruvian() {
            Game game = Game.newGame().playMoves(Pair.of(E2, E4), Pair.of(D7, D5), Pair.of(E4, D5), Pair.of(D8, D5), Pair.of(B1, C3), Pair.of(D5, A5), Pair.of(D2, D4),
            ...
            assertThat(game.pgnMoves()).containsExactlyInAnyOrder("e4 d5 exd5 Qxd5 Nc3 Qa5 d4 c6 Nf3 Bg4 Bf4 e6 h3 Bxf3 Qxf3 Bb4 Be2 Nd7 a3 O-O-O axb4 Qxa1+ Kd2 Qxh1 Qxc6+ bxc6 Ba6#".split(" "));
        }
    }
}