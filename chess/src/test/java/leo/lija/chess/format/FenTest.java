...
class FenTest {
    ...
    class export {
        ...
        class Opening {
            ...
            void newGame() {
                assertThat(Fen.obj2Str(new Game())).isEqualTo("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
            }

            @Test
            @DisplayName("one move")
            void oneMove() {
                assertThat(Fen.obj2Str(new RichGame().playMoveList(moves.stream().limit(1).toList())))
            ...
            @DisplayName("2 moves")
            void twoMoves() {
                assertThat(Fen.obj2Str(new RichGame().playMoveList(moves.stream().limit(2).toList())))
            ...
            @DisplayName("3 moves")
            void threeMoves() {
                assertThat(Fen.obj2Str(new RichGame().playMoveList(moves.stream().limit(3).toList())))
            ...
            @DisplayName("4 moves")
            void fourMoves() {
                assertThat(Fen.obj2Str(new RichGame().playMoveList(moves.stream().limit(4).toList())))
            ...
            @DisplayName("5 moves")
            void fiveMoves() {
                assertThat(Fen.obj2Str(new RichGame().playMoveList(moves.stream().limit(5).toList())))
    ...
    class Import {
        ...
        class Torus {
            ...
            @DisplayName("A8 + 1")
            void a8p1() {
                assertThat(Fen.tore(A8, 1)).contains(B8);
            }

            @Test
            @DisplayName("A8 + 2")
            void a8p2() {
                assertThat(Fen.tore(A8, 2)).contains(C8);
            }

            @Test
            @DisplayName("A8 + 7")
            void a8p7() {
                assertThat(Fen.tore(A8, 7)).contains(H8);
            }

            @Test
            @DisplayName("A8 + 8")
            void a8p8() {
                assertThat(Fen.tore(A8, 8)).contains(A7);
            }

            @Test
            @DisplayName("C4 + 3")
            void c4p3() {
                assertThat(Fen.tore(C4, 3)).contains(F4);
            }

            @Test
            @DisplayName("C4 + 8")
            void c4p8() {
                assertThat(Fen.tore(C4, 8)).contains(C3);
            }

            @Test
            @DisplayName("F1 + 2")
            void f1p2() {
                assertThat(Fen.tore(F1, 2)).contains(H1);
            }
        }
        ...
        private void compare(List<Pair<Pos, Pos>> ms, String fen) {
            ...
            Optional<Situation> os = Fen.str2Obj(fen);
