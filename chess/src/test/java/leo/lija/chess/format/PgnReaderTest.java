...
Rh5 52. Kf2 Rg5 53. Rf8 Ke5 1/2-1/2""";
    ...
    String fromProd = "d4 Nf6 c4 e6 Nc3 Bb4 Bd2 O-O Nf3 c6 e4 Qa5 Be2 Kh8 O-O h5 Ne5 h4 h3 Be7 Nd5 Qd8 Nxe7 d6 Ne7g6+";
    ...
    class RawMoves {
        ...
        @Test
        @DisplayName("example from prod")
        void fromProd() {
            assertThat(PgnReader.apply(fromProd).moves()).hasSize(fromProd.split(" ").length);
        }
    }
