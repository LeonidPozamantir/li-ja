...
Rh5 52. Kf2 Rg5 53. Rf8 Ke5 1/2-1/2""";
    ...
    String fromProd1 = "d4 Nf6 c4 e6 Nc3 Bb4 Bd2 O-O Nf3 c6 e4 Qa5 Be2 Kh8 O-O h5 Ne5 h4 h3 Be7 Nd5 Qd8 Nxe7 d6 Ne7g6+";

    String promoteRook = "d4 Nf6 f3 d5 e3 e5 Ne2 Bd6 g3 a5 Bg2 Bf5 e4 Bb4+ Nbc3 Bxc3+ Nxc3 exd4 Qxd4 Be6 O-O Nc6 Qf2 Qd6 Bf4 Ne5 Bxe5 Qxe5 Rfd1 Ra6 Rd2 c6 Rad1 Bd7 exd5 b5 d6 Rg8 f4 Qe6 Qc5 Kf8 Bf3 Ke8 Kg2 Kf8 Re2 Qc4 Qxc4 bxc4 h3 Be8 Bg4 h5 Bf5 c5 Red2 g6 Be4 Rb6 Kf3 Kg7 g4 hxg4+ hxg4 Ra6 f5 Ra7 Nd5 g5 Nxf6 Kxf6 b3 Bb5 bxc4 Bxc4 d7 Rxd7 Rxd7 Bxa2 Rd8 Rxd8 Rxd8 a4 Ra8 Ke7 Rxa4 Bb1 c4 Bxe4+ Kxe4 Kd6 f6 Ke6 Ra6+ Kd7 Kf5 Kc7 Kxg5 Kb8 Kh6 Kc7 g5 Kb8 g6 fxg6 Kxg6 Kc7 f7 Kb7 Rd6 Ka7 f8=R Kb7 Rf7+";

    @Nested
    @DisplayName("only raw moves")
    class RawMoves {

        @Test
        @DisplayName("many games")
        void allGames() {
            assertThat(raws)
                .isNotEmpty()
                .allMatch(cur ->
        ...
        @Test
        @DisplayName("example from prod 1")
        void fromProd() {
            assertDoesNotThrow(() -> PgnReader.apply(fromProd1));
        }

        @Test
        @DisplayName("rook promotion")
        void rookPromotion() {
            assertDoesNotThrow(() -> PgnReader.apply(promoteRook));
        }
    }

    @Nested
    @DisplayName("tags and moves")
    class TagsMoves {

        @Test
        void chess960() {
            assertDoesNotThrow(() -> PgnReader.apply(complete960));
        }

        @Test
        @DisplayName("example from wikipedia")
        void fromWiki() {
            assertDoesNotThrow(() -> PgnReader.apply(fromWikipedia));
        }

        @Test
        @DisplayName("example from chessgames.com")
        void fromChessgames() {
            assertDoesNotThrow(() -> PgnReader.apply(fromChessgames));
        }
    }
